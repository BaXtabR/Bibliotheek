...
{
    public partial class frmoverzichtgebruikers : Form
    {
        public frmoverzichtgebruikers()
        {
            InitializeComponent();
        }

        private void frmoverzichtgebruikers_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * from tblGebruiker";
                ...
                dgvOverzichtGebruikers.DataSource = mijnDataSat.Tables[0];
            }
            catch (Exception ex)
            {
