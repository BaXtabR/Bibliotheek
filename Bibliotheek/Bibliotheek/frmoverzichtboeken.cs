...
{
    public partial class frmoverzichtboeken : Form
    {
        public frmoverzichtboeken()
        {
            InitializeComponent();
        }

        private void frmoverzichtboeken_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dgvOverzichtboeken.DataSource = mijnDataSat.Tables[0];
            }
            catch (Exception ex)
            {
